    ...
    <div className="modaly" onClick={props.onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-body">
          ...
          <div className="row">
            {/* {Going to use total 12 columns out which 9 columns is for `field` and 3 columns for `the text on the right side of the field` from `bootstrap` with `fieldContainer`} */}
